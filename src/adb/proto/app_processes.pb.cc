...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AppProcesses_app_5fprocesses_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsscc_info_AppProcesses_app_5fprocesses_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ProcessEntry_app_5fprocesses_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_ProcessEntry_app_5fprocesses_2eproto}, {}};
